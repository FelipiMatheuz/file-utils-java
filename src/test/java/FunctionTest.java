...
public class FunctionTest {
    ...
    public void testJson2ExcelSingle() {
        assertTrue(Json2Excel.generate(VariablesTest.jsonMock, VariablesTest.epMock));
        System.out.println("Excel file generated:\n" + VariablesTest.epMock.getFileName());
    }
    ...
    public void testJson2ExcelMultiple() {
        ...
        jsonMocks.add(VariablesTest.jsonMock);
        jsonMocks.add(VariablesTest.jsonMock);
        assertTrue(Json2Excel.generate(jsonMocks, VariablesTest.epMock));
        System.out.println("Excel file generated:\n" + VariablesTest.epMock.getFileName());
    }
    ...
    public void testExcel2Json() {
        List<String> jsonList = Excel2Json.generate(VariablesTest.epMock);
    ...
    public void testJson2Csv() {
        assertTrue(Json2Csv.generate(VariablesTest.jsonMock, VariablesTest.cpMock));
        System.out.println("CSV file generated:\n" + VariablesTest.cpMock.getFileName());
    }

    @Test
    @DisplayName("Test CSV -> JSON")
    public void testCsv2Json() {
        String json = Csv2Json.generate(VariablesTest.cpMock);
        assertNotNull(json);
